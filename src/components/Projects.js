    ...
    <>
      <div id="projects" className="flexi-row py-4">
        <a target="_blank" rel="noreferrer" href="https://painterest.netlify.app/" alt="Painterest" className="proj-img-cont">
          <img data-aos="fade-right" className="proj-img" src="https://res.cloudinary.com/dk0r9bcxy/image/upload/v1633015751/portfolio-website/Screenshot_2021-09-30_at_16.27.55_gmiqdc.png" />
        </a>
        <div data-aos="fade-left" className="proj-desc-cont">
      ...
      <div className="flexi-row py-4">
        <a target="_blank" rel="noreferrer" href="https://airstudio-project.netlify.app/" alt="AiStudio" className="proj-img-cont">
          <img data-aos="fade-right" className="proj-img" src="https://res.cloudinary.com/dk0r9bcxy/image/upload/v1633015744/portfolio-website/Screenshot_2021-09-30_at_16.28.16_adbkxe.png" />
        </a>
        <div data-aos="fade-left" className="proj-desc-cont">
